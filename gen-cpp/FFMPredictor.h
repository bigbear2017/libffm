...
class FFMPredictorIfSingletonFactory : virtual public FFMPredictorIfFactory {
 public:
  FFMPredictorIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<FFMPredictorIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<FFMPredictorIf> iface_;
};
...
class FFMPredictorClient : virtual public FFMPredictorIf {
 public:
  FFMPredictorClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  FFMPredictorClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class FFMPredictorProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  FFMPredictorProcessor(::apache::thrift::stdcxx::shared_ptr<FFMPredictorIf> iface) :
    iface_(iface) {
...
class FFMPredictorProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  FFMPredictorProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< FFMPredictorIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< FFMPredictorIfFactory > handlerFactory_;
};

class FFMPredictorMultiface : virtual public FFMPredictorIf {
 public:
  FFMPredictorMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<FFMPredictorIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~FFMPredictorMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<FFMPredictorIf> > ifaces_;
  FFMPredictorMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<FFMPredictorIf> iface) {
...
class FFMPredictorConcurrentClient : virtual public FFMPredictorIf {
 public:
  FFMPredictorConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  FFMPredictorConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
